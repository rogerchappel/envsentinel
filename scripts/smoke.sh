...
node dist/cli.js scan fixtures/drift --format json --out reports/drift.json || true
node dist/cli.js scan fixtures/secret-example --fail-on high --out reports/secret.md && {
